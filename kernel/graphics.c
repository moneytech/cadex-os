    ...
    while (command && command->type) {
        switch (command->type) {
            ...
            case GRAPHICS_BGCOLOR:
                ...
                break;
            case GRAPHICS_RECT:
                graphics_rect(g, command->args[0], command->args[1],
                              command->args[2], command->args[3]);
                break;
            case GRAPHICS_CLEAR:
                graphics_clear(g, command->args[0], command->args[1],
                               command->args[2], command->args[3]);
                break;
            case GRAPHICS_LINE:
                graphics_line(g, command->args[0], command->args[1],
                              command->args[2], command->args[3]);
                break;
            case GRAPHICS_TEXT:
                ...
                int i;
                for (i = 0; str[i]; i++) {
                    graphics_char(g, command->args[0] + i * 8, command->args[1],
                                  str[i]);
                }
                break;
