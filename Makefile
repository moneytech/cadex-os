...
run: ${ISO_FILENAME}
	...
	@qemu-system-x86_64.exe -cdrom ${ISO_FILENAME} -m size=500M -drive 'file=hard_disk.img,format=qcow2' -serial stdio --no-acpi -no-reboot -device vmware-svga -sdl -soundhw pcspk,sb16,adlib
