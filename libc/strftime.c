        ...
        switch (*f) {
            ...
            case 'c':
                b += sprintf(b, "%s %s %02d %02d:%02d:%02d %04d",
                             ...
                             months_short[tm->tm_mon], tm->tm_mday, tm->tm_hour,
            ...
            case 'd':
                ...
                break;
            case 'D':
                b += sprintf(b, "%02d/%02d/%02d", tm->tm_mon + 1, tm->tm_mday,
                             tm->tm_year % 100);
                break;
            case 'e':
                ...
                break;
            case 'F':
                b += sprintf(b, "%04d-%02d-%02d", tm->tm_year + 1900,
            ...
            case 'r':
                b += sprintf(
                    ...
                    tm->tm_hour == 0
                        ? 12
                        : (tm->tm_hour == 12 ? 12 : (tm->tm_hour % 12)),
                    tm->tm_min, tm->tm_sec, tm->tm_hour < 12 ? "AM" : "PM");
                break;
            case 'R':
            ...
            case 't':
                ...
                break;
            case 'T':
                b += sprintf(b, "%02d:%02d:%02d", tm->tm_hour, tm->tm_min,
                             tm->tm_sec);
                break;
            case 'u':
