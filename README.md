...
Uncomment the `# run` near the `all:` in the Makefile to run the OS in QEMU after building.
This line is commented because this is preventing the CI from building. 
