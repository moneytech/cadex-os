...
class Console {
     ...
     */
    static auto PutChar(char value) -> void { printf_putchar(value); }

    /**
     * Prints an integer value to the console
     * @param value The value to print to the console
     */
    static auto PutInt(int value) -> void { printf("%d", value); }

    /**
     * Prints a hexadecimal value to the console
     * @param value The value to print to the console
     */
    static auto PutHex(uint32_t value) -> void { printf("%x", value); }
