 ...
 * module functions
 * 
 * Derived from the sources of linux kernel 2.6-11.6
*/

#ifndef _LIBRARY_MODULE_H
#define _LIBRARY_MODULE_H
/*
...
struct module_attribute
{
    ...
    size_t (*show)(struct module_attribute *, struct module *, char *);
    size_t (*store)(struct module_attribute *, struct module *,
...
#define __EXPORT_SYMBOL(sym, sec)                                                  \
    ...
    static const char __kstrtab_##sym[]                                            \
        __attribute__((section("__ksymtab_strings"))) = MODULE_SYMBOL_PREFIX #sym; \
    static const struct kernel_symbol __ksymtab_##sym                              \
        __attribute_used__                                                         \
        __attribute__((section("__ksymtab" sec), unused)) = {(unsigned long)&sym, __kstrtab_##sym}
