...
extern void flush();
extern void render_window(int wd);
...
extern void system(char* program, int argc, const char** argv);
extern void resetColor();
extern void draw_cadex_logo(int x, int y);
extern void draw_window_border(int x, int y, int w, int h, int thickness, int r,
    int g, int b);
